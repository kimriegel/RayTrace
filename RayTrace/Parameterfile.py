...
ipname = 'Env/ComplexBuilding/ComplexBuildingFixed3.obj'
Fs = 24000.0
xinitial = 145.0
yinitial = 35.0
zinitial = 0.0
...
boomspacing = .6   # .6
strat_height = 2.0
type = 1 # changes atmospheric compute, 1 for constant atmosphere 2 for changing temperature 
# boomspacing= 0.035
# boomspacing= 0.1
# boomspacing= 1
xmin = -1
...
outputfile = "RayTest" + str(boomspacing) + ".txt"       # debugging
graphName = "RayTest"                                     # No not use full file extension here
# Will's
