...
#    for D in range(1,arraysize):
    while D < arraysize:
 #       print('outputarray2', outputarray[0,1])
 #       print('outputarray3', outputarray[0,2])
 #       print('outputarray4', outputarray[0,3])
 #       print('temparray1',temparray[D,0,0])
 #       print('temparray2',temparray[D,0,1])
 #       print('temparray3',temparray[D,0,2])
...
def InitialGrid(radius,A,B,C,D,theta,phi,xmin,ymin,zmin,xmax,ymax,zmax,arraysize):
    ...
    #Going to look into defining as a global or going back to for loop 
    #since it's essentially the same this way -G
    #print(" i = ", i) 
    if xmin == xmax:
        while i < int((zmax-zmin)/zspace):
            while j < int((ymax-ymin/yspace)):
        ...
        sizez=1
    if ymin == ymax:
        while i < int((xmax-xmin)/(xspace)):
            while j < int((zmax-zmin)/(zspace)):
