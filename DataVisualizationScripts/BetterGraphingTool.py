...
c = 'OrigFor_complex_comparison_006.dat' #Putting Fortran file into a variable for function

a = 'Validation_Simple_Type1_BS006.txt'  #putting Python file into a variable for function
