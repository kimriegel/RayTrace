/*******************************************************************************
 *
 *  LoBoomFDTD3D_MultiBldg_2006.cpp
 *  
 ...
 *  building structures using a 3-dimensional FDTD method.  A simple 
 *  second-order centered-difference scheme in spatial domain and a fourth-order
 *  Runge-Kutta time integration method were applied to the linearized Euler 
...
float fs,rho,c0,z0,dx,CFL,dt,t_max,sigma_m,B,angle_elv,theta;
...
float extra_dim_x,extra_dim_y,buffer_dim_x,buffer_dim_z;
int num_mics;
vector<Mic> mics;
...
{  
  ...
  float c_LDDRK4[4] = {1, 0.5, 0.162997, 0.0407574};
  float beta_LDDRK4[4] = {0, c_LDDRK4[3]/c_LDDRK4[2], c_LDDRK4[2]/c_LDDRK4[1], c_LDDRK4[1]};
