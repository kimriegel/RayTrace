 ...
 *     
 *    This module initializes the output files of LoBoomFDTD2D_2006 program
 *  with their proper headings to be read into Tecplot.  The output files 
 *  include the pressure field over the entire computational domain at the 
