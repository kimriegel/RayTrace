...
extern float fs,rho,c0,z0,dx,CFL,dt,t_max,sigma_m,B,angle_elv,angle_azm,theta,phi;
...
extern float extra_dim_x,extra_dim_y,buffer_dim_x,buffer_dim_z,wall_height,wall_thickness;
extern int num_mics;
