 ...
 *     
 *    This module initializes the output files of LoBoomFDTD3D_SingleBldg 
 ...
 *  orthogonal slices over the duration of the simulation, the pressure time
 *  history at the microphone locations, and the snapshots of pressure loading 
 *  on the exterior surfaces of the structure.  The numerical precision for 
...
void InitializeDataFiles()
{
  ...
  // Pressure loading snapshots on the building exterior
  p_surface<<"TITLE = \"Pressure Distribution on Building Exterior\""<<endl;
  p_surface<<"VARIABLES = \"X[m]\" \"Y[m]\" \"Z[m]\" \"P[psf]\""<<endl;
  p_surface<<"TEXT\nCS=FRAME\nX=71.9660948264,Y=82.9866270431\nC=BLACK\nS=LOCAL"<<endl;
  p_surface<<"HU=POINT\nLS=1 AN=MIDCENTER\nBX=Filled BXM=60 LT=0.1 BXO=BLACK BXF=WHITE"<<endl;
  p_surface<<"F=HELV\nH=20 A=0\nMFC=\"\"\nCLIPPING=CLIPTOVIEWPORT\nT=\"Time = &(SOLUTIONTIME%4f)\""<<endl;
